...
error_but = ttk.Button(CEpage, text="Retry", style="Accent.TButton", command= lambda: connect())
error_but.place(x=250, y=250, w=100, h=40)
            ...
            if len(characters) > 0:
                ...
                if code == "@":
                    ...
                    while n < len(words):
                        ...
                        n += 1
                    if recipient == "":
                        add_to_terminal("Unknown recipient")
                    elif message == "":
                        add_to_terminal("Invalid message")
                    else:
...
notebook.add(tab_2, text="Explore")

#===============================================================================================================>Tab 3
tab_3 = ttk.Frame(notebook)
notebook.add(tab_3, text="Settings")

switch = ttk.Checkbutton(tab_3, text="Mode", style="Switch", command=change_theme)
switch.place(x=100, y=100)

logout_but = ttk.Button(tab_3, text="Log out", style="Accent.TButton", command= lambda: logout())
